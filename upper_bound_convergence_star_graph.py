...
def mainfunct(num_simulations):
    ...
    expectedConvergenceTimes = math.e * (2*N - 2) * np.log(N + 2)
...
plt.title('STAR GRAPH: Number of simulations: 500, Number of nodes considered: %d'%num_nodes)
